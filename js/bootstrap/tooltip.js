!function(t, e) {
    "function" == typeof define && define.amd ? define(["jquery"], e) : "object" == typeof exports ? module.exports = e(require("jquery")) : t.Tooltip = e(t.jQuery)
}(this, function(t) {
    +function(t) {
        "use strict";
        var e = function(t, e) {
            ...
            e.prototype.show = function() {
                ...
                if (this.hasContent() && this.enabled) {
                    ...
                    if (p) {
                        ...
                        l = "bottom" == l && h.bottom + u > d.bottom ? "top" : "top" == l && h.top - u < d.top ? "bottom" : "right" == l && h.right + f > d.width ? "left" : "left" == l && h.left - f < d.left ? "right" : l,
                            s.removeClass(c).addClass(l)
                    }
